...
namespace FoodVariable
{
    /// <summary>
    /// A page that displays details for a single item within a group while allowing gestures to
    /// flip through other items belonging to the same group.
    /// </summary>
    public sealed partial class ItemDetailPage : FoodVariable.Common.LayoutAwarePage
    {
      ...
      /*  protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            //CreateLiveTile.ShowliveTile(false, "Baby Gift Centre");
        } */
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            EnableLiveTile.CreateLiveTile.ShowliveTile(false, "The Acne Cure");
        }
